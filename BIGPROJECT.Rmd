...
completeMap$ACRES <- completeMap$COUNT *0.222

completeMap$ACRES_TOTAL <- completeMap$TOTAL *0.222
...
usMap <- readOGR(dsn = "./tl_2019_us_county.shp", layer ="tl_2019_us_county", stringsAsFactors = FALSE)
...
colnames(countyTotal)[colnames(countyTotal)=="GEOID10"] <- "GEOID"
